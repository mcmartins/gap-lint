    ...
    try {
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 17:
                    localctx = new ComponentObjectExpressionContext(this, new ExpressionContext(this, _parentctx, _parentState));
                    this.pushNewRecursionContext(localctx, _startState, gapParser.RULE_expression);
                    this.state = 256;
                    ...
                    this.state = 257;
                    this.match(gapParser.ComponentObject);
                    this.state = 258;
                    this.expression(12);
                    break;

                case 18:
                    localctx = new AccessMemberExpressionContext(this, new ExpressionContext(this, _parentctx, _parentState));
                    this.pushNewRecursionContext(localctx, _startState, gapParser.RULE_expression);
                    this.state = 259;
